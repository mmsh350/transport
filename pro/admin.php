...
<body class="hold-transition sidebar-mini  bg-dark">
    <div class="wrapper text-dark">
        ...
        <aside class="main-sidebar sidebar-dark-success">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item">
                            <a href="admin.php" style="<?php echo (@$_GET['page'] == '') ? 'background-color:#f8198d;' : ''; ?>" class="nav-link <?php if (!isset($_GET['page'])) echo 'active'; ?>">
                        ...
                        <li class="nav-item">
                            <a href="admin.php?page=users" style="<?php echo (@$_GET['page'] == 'users') ? 'background-color:#f8198d;' : ''; ?>" class="nav-link 
                            <?php
                        ...
                        <li class="nav-item">
                            <a href="admin.php?page=dynamic" style="<?php echo (@$_GET['page'] == 'dynamic') ? 'background-color:#f8198d;' : ''; ?>" class="nav-link 
                            <?php
                        ...
                        <li class="nav-item">
                            <a href="admin.php?page=route" style="<?php echo (@$_GET['page'] == 'route') ? 'background-color:#f8198d;' : ''; ?>" class="nav-link      <?php
                        ...
                        <li class="nav-item">
                            <a href="admin.php?page=train" style="<?php echo (@$_GET['page'] == 'train') ? 'background-color:#f8198d;' : ''; ?>" class="nav-link      <?php
                        ...
                        <li class="nav-item">
                            <a href="admin.php?page=report" style="<?php echo (@$_GET['page'] == 'report') ? 'background-color:#f8198d;' : ''; ?>" class="nav-link      <?php
                        ...
                        <li class="nav-item">
                            <a href="admin.php?page=payment" style="<?php echo (@$_GET['page'] == 'payment') ? 'background-color:#f8198d;' : ''; ?>" class="nav-link      <?php
                        ...
                        <li class="nav-item">
                            <a href="admin.php?page=feedback" style="<?php echo (@$_GET['page'] == 'feedback') ? 'background-color:#f8198d;' : ''; ?>" class="nav-link      <?php
                        ...
                        <li class="nav-item">
                            <a href="admin.php?page=search" style="<?php echo (@$_GET['page'] == 'search') ? 'background-color:#f8198d;' : ''; ?>" class="nav-link      <?php
                        ...
                        <li class="nav-item">
                            <a href="admin.php?page=track" style="<?php echo (@$_GET['page'] == 'track') ? 'background-color:#f8198d;' : ''; ?>" class="nav-link      <?php
                                                                                    echo (@$_GET['page'] == 'track') ? 'active' : '';
                                                                                    ?>">
        ...
        <!-- Control Sidebar -->
        <aside class="control-sidebar control-sidebar-dark  text-dark">
        ...
        <!-- Main Footer -->
        <footer class="main-footer bg-dark text-dark">
            <!-- To the right -->
