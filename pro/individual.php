            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item has-treeview menu-open">
                            <a href="individual.php" style="<?php echo (@$_GET['page'] == '') ? 'background-color:#f8198d;' : ''; ?>" class="nav-link <?php echo (@$_GET['page'] == '') ? 'active' : '';?>">
                        ...
                        <li class="nav-item">
                            <a href="individual.php?page=reg" style="<?php echo (@$_GET['page'] == 'reg') ? 'background-color:#f8198d;' : ''; ?>" class="nav-link <?php echo (@$_GET['page'] == 'reg') ? 'active' : '';?>">
                                <i class="fa fa-plus nav-icon"></i>
                                <p>New Booking</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="individual.php?page=paid" style="<?php echo (@$_GET['page'] == 'paid') ? 'background-color:#f8198d;' : ''; ?>" class="nav-link <?php echo (@$_GET['page'] == 'paid') ? 'active' : '';?>">
                                <i class="fa fa-book nav-icon"></i>
                                <p>View Bookings</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="individual.php?page=feedback" style="<?php echo (@$_GET['page'] == 'feedback') ? 'background-color:#f8198d;' : ''; ?>" class="nav-link <?php echo (@$_GET['page'] == 'feedback') ? 'active' : '';?>">
