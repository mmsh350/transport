...
<div class="content">
    ...
    <section class="content">
        ...
        <tr><th>Seat No.</th><td>$row[seat]</td></tr>
        ...
        <tr><th>Vehicle</th><td>" . getTrainName($row['train_id']) . "</td></tr>
        </table>";
                                }
                            }
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content" align="center">
            <div class="modal-header">
                <h4 class="modal-title">Search With Ticket ID
                </h4>
                ...
                <form action="" method="post">
                    ...
                    <table class="table table-bordered">
                        ...
                        <td colspan="2">
                            ...
                            <input class="btn" style='background-color:#f8198d; color:white;' type="submit" value="Search" name='submit'>
                        </td>
                        </tr>
                    </table>
                </form>
