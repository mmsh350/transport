                    ...
                    <div class="card card-success">
                        <div class="card-header bg-dark text-dark">
                            ...
                            <div class='float-right'>
                                ...
                                </button> - - - <button type="button" class="btn btn-secondary btn-sm" data-toggle="modal"
                                    data-target="#add2">
                                    Add Range Schedule &#x1F68C;
                                </button>
                            </div>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form action="" method="post">
                                                        ...
                                                        <p>
                                                             Charge/Fee : <input class="form-control"
                                                        ...
                                                        <p class="float-right "><input type="submit" name="edit"
                                                                class="btn btn" style='background-color:#f8198d; color:white;' value="Edit Schedule"></p>
                                                    </form>
...
<div class="modal fade" id="add">
    <div class="modal-dialog modal-lg">
        <div class="modal-content" align="center">
            <div class="modal-header">
                <h4 class="modal-title text-dark" >Add New Schedule &#x1F68C;
                </h4>
            ...
            <div class="modal-body">
                <form action="" method="post" class="text-dark">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            Route : <select class="form-control" name="route_id" required id="">
                             ...
                             Charge/ Fee: <input class="form-control" type="number" name="first_fee" required
                                id="">
                        

                           <span hidden> Second Class Charge :</span> <input hidden class="form-control" value="0" type="number" name="second_fee" required
                                id="">
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <hr>
                    <input type="submit" name="submit" class="btn" style='background-color:#f8198d; color:white;' value="Add Schedule"></p>
                </form>
...
<div class="modal fade text-dark" id="add2">
    <div class="modal-dialog modal-lg">
        <div class="modal-content" align="center">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form action="" method="post">
                    ...
                    <hr>
                    <input type="submit" name="submit2" class="btn" style='background-color:#f8198d; color:white;' value="Add Schedule"></p>
                </form>
